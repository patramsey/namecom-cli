...
**Filed 2026-08-20 as [namedotcom/core-api-go#3](https://github.com/namedotcom/core-api-go/issues/3).** Kept here so the reproduction stays with the repository that produced it.
