...
**Filed 2026-08-20 as [namedotcom/core-api-go#4](https://github.com/namedotcom/core-api-go/issues/4), fixed upstream in v1.33.3, closed 2026-08-26.** The suggested fix below was adopted, factored into a `sleepWithContext` helper. Kept here so the reproduction and the measurements stay with the repository that produced them.
